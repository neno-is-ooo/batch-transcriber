"""CLI entry point for faster-whisper-batch."""
...
from .worker import print_capabilities, process_manifest


def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(prog="faster-whisper-batch")
